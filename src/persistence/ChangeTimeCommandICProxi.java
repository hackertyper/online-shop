...
public class ChangeTimeCommandICProxi extends PersistentInCacheProxi implements PersistentChangeTimeCommand{
    
    public ChangeTimeCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeTimeCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theChangeTimeCommandFacade
            .getChangeTimeCommand(this.getId());
    }
