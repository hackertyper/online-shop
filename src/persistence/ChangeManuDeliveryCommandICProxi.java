...
public class ChangeManuDeliveryCommandICProxi extends PersistentInCacheProxi implements PersistentChangeManuDeliveryCommand{
    
    public ChangeManuDeliveryCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeManuDeliveryCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theChangeManuDeliveryCommandFacade
            .getChangeManuDeliveryCommand(this.getId());
    }
