...
public class CheckedOutProxi extends CartStateProxi implements CheckedOutView{
    
    public CheckedOutProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public CheckedOutView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        CheckedOutView result$$ = new CheckedOut( this.getId(), this.getClassId());
