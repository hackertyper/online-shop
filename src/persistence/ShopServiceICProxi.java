...
public class ShopServiceICProxi extends CustomerServiceICProxi implements PersistentShopService{
    
    public ShopServiceICProxi(long objectId) {
        super(objectId);
    }
    public ShopServiceICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theShopServiceFacade
            .getShopService(this.getId());
    }
