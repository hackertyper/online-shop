...
public class StandardDelivery extends view.objects.CustomerDelivery implements StandardDeliveryView{
    
    
    public StandardDelivery(long time,long extraCharge,long id, long classId) {
