...
public class CheckedOutICProxi extends CartStateICProxi implements PersistentCheckedOut{
    
    public CheckedOutICProxi(long objectId) {
        super(objectId);
    }
    public CheckedOutICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theCheckedOutFacade
            .getCheckedOut(this.getId());
    }
