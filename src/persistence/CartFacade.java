...
public class CartFacade{
    ...
    public PersistentCart newCart(long currentSum,long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentCart)PersistentProxi.createProxi(idCreateIfLessZero, 203);
        ...
        return (PersistentCart)PersistentProxi.createProxi(id, 203);
    }
