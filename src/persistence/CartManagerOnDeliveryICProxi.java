...
public class CartManagerOnDeliveryICProxi extends PersistentInCacheProxiOptimistic implements PersistentCartManagerOnDelivery{
    
    public CartManagerOnDeliveryICProxi(long objectId) {
        super(objectId);
    }
    public CartManagerOnDeliveryICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theCartManagerOnDeliveryFacade
            .getCartManagerOnDelivery(this.getId());
    }
