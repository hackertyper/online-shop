...
public class PayCommandICProxi extends PersistentInCacheProxi implements PersistentPayCommand{
    
    public PayCommandICProxi(long objectId) {
        super(objectId);
    }
    public PayCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().thePayCommandFacade
            .getPayCommand(this.getId());
    }
