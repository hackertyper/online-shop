...
public class ChangeDescriptionCommandProxi extends PersistentProxi implements PersistentChangeDescriptionCommand{
    
    public ChangeDescriptionCommandProxi(long objectId) {
        super(objectId);
    }
    public ChangeDescriptionCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
