...
public class ChangeChargeCommandProxi extends PersistentProxi implements PersistentChangeChargeCommand{
    
    public ChangeChargeCommandProxi(long objectId) {
        super(objectId);
    }
    public ChangeChargeCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
