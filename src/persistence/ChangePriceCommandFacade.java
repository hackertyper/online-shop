...
public class ChangePriceCommandFacade{
    ...
    public PersistentChangePriceCommand newChangePriceCommand(long newPrice,long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentChangePriceCommand)PersistentProxi.createProxi(idCreateIfLessZero, 205);
        ...
        return (PersistentChangePriceCommand)PersistentProxi.createProxi(id, 205);
    }
