...
public class ProductGroupItemListProxi extends PersistentProxi implements PersistentProductGroupItemList{
    
    public ProductGroupItemListProxi(long objectId) {
        super(objectId);
    }
    public ProductGroupItemListProxi(PersistentInCacheProxi object) {
        super(object);
    }
