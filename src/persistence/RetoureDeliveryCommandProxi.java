...
public class RetoureDeliveryCommandProxi extends PersistentProxi implements PersistentRetoureDeliveryCommand{
    
    public RetoureDeliveryCommandProxi(long objectId) {
        super(objectId);
    }
    public RetoureDeliveryCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
