...
public class InvalidOrderAmount extends model.UserException{
    ...
    public InvalidOrderAmount(String message) throws PersistenceException {
        super(message);        
    }
