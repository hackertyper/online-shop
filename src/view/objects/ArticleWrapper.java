...
public class ArticleWrapper extends ViewObject implements ArticleWrapperView{
    
    protected long price;
    protected long stock;
    protected ArticleView myArticle;
    
    public ArticleWrapper(long price,long stock,ArticleView myArticle,long id, long classId) {
