...
public class FindArticleCommand extends PersistentObject implements PersistentFindArticleCommand{
    ...
    public FindArticleCommand(String description,Invoker invoker,PersistentCustomer commandReceiver,PersistentCommonDate myCommonDate,long id) throws PersistenceException {
