...
public class CheckedOutFacade{
    ...
    public PersistentCheckedOut newCheckedOut(long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentCheckedOut)PersistentProxi.createProxi(idCreateIfLessZero, 218);
        ...
        return (PersistentCheckedOut)PersistentProxi.createProxi(id, 218);
    }
