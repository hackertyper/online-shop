...
public class CartManagerArticleListProxi extends PersistentProxi implements PersistentCartManagerArticleList{
    
    public CartManagerArticleListProxi(long objectId) {
        super(objectId);
    }
    public CartManagerArticleListProxi(PersistentInCacheProxi object) {
        super(object);
    }
