...
public class CustomerOrder extends view.objects.Delivery implements CustomerOrderView{
    ...
    public CustomerOrder(long remainingTimeToDelivery,java.util.Date sentDate,java.util.Vector<QuantifiedArticlesView> articleList,OrderManagerView ordermngr,CustomerOrderState myState,long id, long classId) {
