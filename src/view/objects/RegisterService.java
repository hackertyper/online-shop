...
public class RegisterService extends view.objects.Service implements RegisterServiceView{
    
    
    public RegisterService(java.util.Vector<ErrorDisplayView> errors,long id, long classId) {
