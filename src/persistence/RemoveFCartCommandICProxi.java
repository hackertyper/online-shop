...
public class RemoveFCartCommandICProxi extends PersistentInCacheProxi implements PersistentRemoveFCartCommand{
    
    public RemoveFCartCommandICProxi(long objectId) {
        super(objectId);
    }
    public RemoveFCartCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theRemoveFCartCommandFacade
            .getRemoveFCartCommand(this.getId());
    }
