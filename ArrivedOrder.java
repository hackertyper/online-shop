...
public class ArrivedOrder extends PersistentObject implements PersistentArrivedOrder{
    ...
    public ArrivedOrder(long timeToAccept,PersistentArrivedOrder This,long id) throws PersistenceException {
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 137) ConnectionHandler.getTheConnectionHandler().theArrivedOrderFacade
