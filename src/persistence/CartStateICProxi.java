...
public abstract class CartStateICProxi extends PersistentInCacheProxiOptimistic implements PersistentCartState{
    
    public CartStateICProxi(long objectId) {
        super(objectId);
    }
    public CartStateICProxi(PersistentObject object) {
        super(object);
    }
