...
public class ChangeAmountCommandICProxi extends PersistentInCacheProxi implements PersistentChangeAmountCommand{
    
    public ChangeAmountCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeAmountCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theChangeAmountCommandFacade
            .getChangeAmountCommand(this.getId());
    }
