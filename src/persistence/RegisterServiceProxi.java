...
public class RegisterServiceProxi extends ServiceProxi implements PersistentRegisterService{
    
    public RegisterServiceProxi(long objectId) {
        super(objectId);
    }
    public RegisterServiceProxi(PersistentInCacheProxi object) {
        super(object);
    }
