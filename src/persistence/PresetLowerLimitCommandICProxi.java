...
public class PresetLowerLimitCommandICProxi extends PersistentInCacheProxi implements PersistentPresetLowerLimitCommand{
    
    public PresetLowerLimitCommandICProxi(long objectId) {
        super(objectId);
    }
    public PresetLowerLimitCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().thePresetLowerLimitCommandFacade
            .getPresetLowerLimitCommand(this.getId());
    }
