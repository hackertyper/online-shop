...
public class ProductGroupItemList extends PersistentObject implements PersistentProductGroupItemList{
    
    /** Throws persistence exception if the object with the given id does not exist. */
    public static PersistentProductGroupItemList getById(long objectId) throws PersistenceException{
        long classId = ConnectionHandler.getTheConnectionHandler().theProductGroupItemListFacade.getClass(objectId);
        return (PersistentProductGroupItemList)PersistentProxi.createProxi(objectId, classId);
    }
    
    public static PersistentProductGroupItemList createProductGroupItemList() throws PersistenceException{
        return createProductGroupItemList(false);
    }
    
    public static PersistentProductGroupItemList createProductGroupItemList(boolean delayed$Persistence) throws PersistenceException {
        PersistentProductGroupItemList result = null;
        if(delayed$Persistence){
            result = ConnectionHandler.getTheConnectionHandler().theProductGroupItemListFacade
                .newDelayedProductGroupItemList();
            result.setDelayed$Persistence(true);
        }else{
            result = ConnectionHandler.getTheConnectionHandler().theProductGroupItemListFacade
                .newProductGroupItemList(-1);
        }
        while (!(result instanceof ProductGroupItemList)) result = (PersistentProductGroupItemList)result.getTheObject();
        ((ProductGroupItemList)result).setThis(result);
        return result;
    }
    
    public ProductGroupItemList provideCopy() throws PersistenceException{
        ProductGroupItemList result = this;
        result = new ProductGroupItemList(this.observer, 
                                          this.This, 
                                          this.getId());
    ...
    protected ProductGroupItemList_ObserveeProxi observee;
    protected PersistentProductGroupItemList This;
    
    public ProductGroupItemList(PersistentProductGroup observer,PersistentProductGroupItemList This,long id) throws PersistenceException {
        /* Shall not be used by clients for object construction! Use static create operation instead! */
        super(id);
        this.observer = observer;
        this.observee = new ProductGroupItemList_ObserveeProxi(this);
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 245) ConnectionHandler.getTheConnectionHandler().theProductGroupItemListFacade
            .newProductGroupItemList(this.getId());
        super.store();
        if(this.getObserver() != null){
            this.getObserver().store();
            ConnectionHandler.getTheConnectionHandler().theProductGroupItemListFacade.observerSet(this.getId(), getObserver());
        }
        this.getObservee().store();
        if(!this.isTheSameAs(this.getThis())){
            this.getThis().store();
            ConnectionHandler.getTheConnectionHandler().theProductGroupItemListFacade.ThisSet(this.getId(), getThis());
        }
    ...
    public void setObserver(PersistentProductGroup newValue) throws PersistenceException {
        ...
        if(!this.isDelayed$Persistence()){
            newValue.store();
            ConnectionHandler.getTheConnectionHandler().theProductGroupItemListFacade.observerSet(this.getId(), newValue);
        }
    }
    public ProductGroupItemList_ObserveeProxi getObservee() throws PersistenceException {
        return this.observee;
    }
    protected void setThis(PersistentProductGroupItemList newValue) throws PersistenceException {
        if (newValue == null) throw new PersistenceException("Null values not allowed!", 0);
        ...
        long objectId = newValue.getId();
        long classId = newValue.getClassId();
        this.This = (PersistentProductGroupItemList)PersistentProxi.createProxi(objectId, classId);
        if(!this.isDelayed$Persistence()){
            newValue.store();
            ConnectionHandler.getTheConnectionHandler().theProductGroupItemListFacade.ThisSet(this.getId(), newValue);
        }
    }
    public PersistentProductGroupItemList getThis() throws PersistenceException {
        if(this.This == null){
            PersistentProductGroupItemList result = (PersistentProductGroupItemList)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentProductGroupItemList)this.This;
    }
    ...
    public void update(final model.meta.Mssgs event) 
				throws PersistenceException{
        this.observer.getThis().itemList_update((model.meta.ItemMssgs)event);
    }
