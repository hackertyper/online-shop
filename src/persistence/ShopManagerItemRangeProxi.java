...
public class ShopManagerItemRangeProxi extends PersistentProxi implements PersistentShopManagerItemRange{
    
    public ShopManagerItemRangeProxi(long objectId) {
        super(objectId);
    }
    public ShopManagerItemRangeProxi(PersistentInCacheProxi object) {
        super(object);
    }
