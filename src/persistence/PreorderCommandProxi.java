...
public class PreorderCommandProxi extends PersistentProxi implements PersistentPreorderCommand{
    
    public PreorderCommandProxi(long objectId) {
        super(objectId);
    }
    public PreorderCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
