...
public class QuantifiedArticlesArticleProxi extends PersistentProxi implements PersistentQuantifiedArticlesArticle{
    
    public QuantifiedArticlesArticleProxi(long objectId) {
        super(objectId);
    }
    public QuantifiedArticlesArticleProxi(PersistentInCacheProxi object) {
        super(object);
    }
