...
public class OfferedFSaleProxi extends ViewProxi implements OfferedFSaleView{
    
    public OfferedFSaleProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
