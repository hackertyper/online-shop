...
public class OfferedFSaleFacade{
    ...
    public PersistentOfferedFSale newOfferedFSale(long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentOfferedFSale)PersistentProxi.createProxi(idCreateIfLessZero, 194);
        ...
        return (PersistentOfferedFSale)PersistentProxi.createProxi(id, 194);
    }
