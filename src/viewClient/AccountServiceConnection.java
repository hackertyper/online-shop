...
public class AccountServiceConnection extends CustomerServiceConnection {
    ...
    public synchronized String accountService_Menu_Filter(Anything anything) throws ModelException{
        try {
            ...
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "accountService_Menu_Filter", parameters);
