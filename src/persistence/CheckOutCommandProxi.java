...
public class CheckOutCommandProxi extends PersistentProxi implements PersistentCheckOutCommand{
    
    public CheckOutCommandProxi(long objectId) {
        super(objectId);
    }
    public CheckOutCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
