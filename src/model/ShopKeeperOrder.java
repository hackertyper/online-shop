...
public class ShopKeeperOrder extends model.Delivery implements PersistentShopKeeperOrder{
    ...
    public static PersistentShopKeeperOrder createShopKeeperOrder(long remainingTimeToDelivery,java.sql.Timestamp sentDate,PersistentArticle article,long amount) throws PersistenceException{
        return createShopKeeperOrder(remainingTimeToDelivery,sentDate,article,amount,false);
    }
    
    public static PersistentShopKeeperOrder createShopKeeperOrder(long remainingTimeToDelivery,java.sql.Timestamp sentDate,PersistentArticle article,long amount,boolean delayed$Persistence) throws PersistenceException {
        PersistentShopKeeperOrder result = null;
        if(delayed$Persistence){
            result = ConnectionHandler.getTheConnectionHandler().theShopKeeperOrderFacade
                .newDelayedShopKeeperOrder(remainingTimeToDelivery,sentDate,amount);
            result.setDelayed$Persistence(true);
        }else{
            result = ConnectionHandler.getTheConnectionHandler().theShopKeeperOrderFacade
                .newShopKeeperOrder(remainingTimeToDelivery,sentDate,amount,-1);
        }
    ...
    public static PersistentShopKeeperOrder createShopKeeperOrder(long remainingTimeToDelivery,java.sql.Timestamp sentDate,PersistentArticle article,long amount,boolean delayed$Persistence,PersistentShopKeeperOrder This) throws PersistenceException {
        PersistentShopKeeperOrder result = null;
        if(delayed$Persistence){
            result = ConnectionHandler.getTheConnectionHandler().theShopKeeperOrderFacade
                .newDelayedShopKeeperOrder(remainingTimeToDelivery,sentDate,amount);
    ...
    public ShopKeeperOrder(long remainingTimeToDelivery,java.sql.Timestamp sentDate,SubjInterface subService,PersistentDelivery This,PersistentArticle article,long amount,long id) throws PersistenceException {
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 175) ConnectionHandler.getTheConnectionHandler().theShopKeeperOrderFacade
            .newShopKeeperOrder(remainingTimeToDelivery,sentDate,amount,this.getId());
        super.store();
