...
public class CancelCommandProxi extends PersistentProxi implements PersistentCancelCommand{
    
    public CancelCommandProxi(long objectId) {
        super(objectId);
    }
    public CancelCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
