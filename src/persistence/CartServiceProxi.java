...
public class CartServiceProxi extends CustomerServiceProxi implements PersistentCartService{
    
    public CartServiceProxi(long objectId) {
        super(objectId);
    }
    public CartServiceProxi(PersistentInCacheProxi object) {
        super(object);
    }
