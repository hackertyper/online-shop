...
public class OrderCommandFacade{
    ...
    public PersistentOrderCommand newOrderCommand(long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentOrderCommand)PersistentProxi.createProxi(idCreateIfLessZero, 143);
        ...
        return (PersistentOrderCommand)PersistentProxi.createProxi(id, 143);
    }
