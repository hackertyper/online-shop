...
public class ChangeDescriptionCommandFacade{
    ...
    public PersistentChangeDescriptionCommand newChangeDescriptionCommand(String newDescription,long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentChangeDescriptionCommand)PersistentProxi.createProxi(idCreateIfLessZero, 160);
        ...
        return (PersistentChangeDescriptionCommand)PersistentProxi.createProxi(id, 160);
    }
