...
public class RemovedFSaleProxi extends PersistentProxi implements PersistentRemovedFSale{
    
    public RemovedFSaleProxi(long objectId) {
        super(objectId);
    }
    public RemovedFSaleProxi(PersistentInCacheProxi object) {
        super(object);
    }
