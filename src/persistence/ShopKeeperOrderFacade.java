...
public class ShopKeeperOrderFacade{
    ...
    public PersistentShopKeeperOrder newShopKeeperOrder(long remainingTimeToDelivery,java.sql.Timestamp sendDate,long amount,long idCreateIfLessZero) throws PersistenceException {
        ...
        ShopKeeperOrder result = new ShopKeeperOrder(remainingTimeToDelivery,sendDate,null,null,null,amount,id);
        Cache.getTheCache().put(result);
        return (PersistentShopKeeperOrder)PersistentProxi.createProxi(id, 130);
    }
    
    public PersistentShopKeeperOrder newDelayedShopKeeperOrder(long remainingTimeToDelivery,java.sql.Timestamp sendDate,long amount) throws PersistenceException {
        long id = ConnectionHandler.getTheConnectionHandler().theDeliveryFacade.getNextId();
        ShopKeeperOrder result = new ShopKeeperOrder(remainingTimeToDelivery,sendDate,null,null,null,amount,id);
        Cache.getTheCache().put(result);
        return (PersistentShopKeeperOrder)PersistentProxi.createProxi(id, 130);
