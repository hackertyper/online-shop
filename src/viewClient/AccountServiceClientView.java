...
public class AccountServiceClientView extends BorderPane implements ExceptionAndEventHandler{
	...
	**/
    ...
    private class WithdrawPRMTRIntegerPRMTRMenuItem extends AccountServiceMenuItem{
    ...
    private java.util.Vector<javafx.scene.control.Button> getToolButtonsForStaticOperations() {
        ...
        currentButton.setOnAction(new EventHandler<ActionEvent>(){
            public void handle(javafx.event.ActionEvent e) {
                final AccountServiceWithdrawIntegerMssgWizard wizard = new AccountServiceWithdrawIntegerMssgWizard("Geld abheben");
    ...
    private ContextMenu getContextMenu(final ViewRoot selected, final boolean withStaticOperations, final Point2D menuPos) {
        ...
        if (selected != null){
            try {
                this.setPreCalculatedFilters(this.getConnection().accountService_Menu_Filter((Anything)selected));
	...
	class AccountServiceDepositIntegerMssgWizard extends Wizard {

		protected AccountServiceDepositIntegerMssgWizard(String operationName){
			super(AccountServiceClientView.this);
			getOkButton().setText(operationName);
			getOkButton().setGraphic(new DepositPRMTRIntegerPRMTRMenuItem ().getGraphic());
		}
		protected void initialize(){
			this.helpFileName = "AccountServiceDepositIntegerMssgWizard.help";
			super.initialize();		
		}
	...
	class AccountServiceWithdrawIntegerMssgWizard extends Wizard {

		protected AccountServiceWithdrawIntegerMssgWizard(String operationName){
			super(AccountServiceClientView.this);
			getOkButton().setText(operationName);
			getOkButton().setGraphic(new WithdrawPRMTRIntegerPRMTRMenuItem ().getGraphic());
		}
		protected void initialize(){
			this.helpFileName = "AccountServiceWithdrawIntegerMssgWizard.help";
			super.initialize();		
		}
	...
	private ImageView getIconForMenuItem(AccountServiceMenuItem menuItem){
