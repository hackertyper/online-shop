...
public class Manufacturer extends PersistentObject implements PersistentManufacturer{
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 165) ConnectionHandler.getTheConnectionHandler().theManufacturerFacade
            .newManufacturer(name,manuDelivery,this.getId());
        super.store();
        if(this.getSubService() != null){
            this.getSubService().store();
            ConnectionHandler.getTheConnectionHandler().theManufacturerFacade.subServiceSet(this.getId(), getSubService());
        }
    ...
    public void setSubService(SubjInterface newValue) throws PersistenceException {
        ...
        if(!this.isDelayed$Persistence()){
            newValue.store();
            ConnectionHandler.getTheConnectionHandler().theManufacturerFacade.subServiceSet(this.getId(), newValue);
        }
    }
