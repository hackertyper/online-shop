...
public class OpenCartICProxi extends CartStateICProxi implements PersistentOpenCart{
    
    public OpenCartICProxi(long objectId) {
        super(objectId);
    }
    public OpenCartICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theOpenCartFacade
            .getOpenCart(this.getId());
    }
