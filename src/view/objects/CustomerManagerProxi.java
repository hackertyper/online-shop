...
public class CustomerManagerProxi extends ViewProxi implements CustomerManagerView{
    
    public CustomerManagerProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
