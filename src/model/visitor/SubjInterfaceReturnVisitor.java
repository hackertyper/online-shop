...
public interface SubjInterfaceReturnVisitor<R> extends ArticleStateReturnVisitor<R> ,CartStateReturnVisitor<R> ,CustomerDeliveryReturnVisitor<R> ,CustomerOrderStateReturnVisitor<R> ,ItemReturnVisitor<R> ,ServiceReturnVisitor<R> {
