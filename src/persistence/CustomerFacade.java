...
public class CustomerFacade{
    ...
    public PersistentCustomer newCustomer(long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentCustomer)PersistentProxi.createProxi(idCreateIfLessZero, 106);
        ...
        return (PersistentCustomer)PersistentProxi.createProxi(id, 106);
    }
