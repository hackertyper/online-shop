...
public class OrderCommandICProxi extends PersistentInCacheProxi implements PersistentOrderCommand{
    
    public OrderCommandICProxi(long objectId) {
        super(objectId);
    }
    public OrderCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theOrderCommandFacade
            .getOrderCommand(this.getId());
    }
