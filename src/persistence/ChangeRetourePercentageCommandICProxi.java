...
public class ChangeRetourePercentageCommandICProxi extends PersistentInCacheProxi implements PersistentChangeRetourePercentageCommand{
    
    public ChangeRetourePercentageCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeRetourePercentageCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theChangeRetourePercentageCommandFacade
            .getChangeRetourePercentageCommand(this.getId());
    }
