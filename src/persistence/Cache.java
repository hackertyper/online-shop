...
/* ********************* Cache report ********************** */	
	...
	private void initializeNumber2NameMap() {
		...
		this.number2NameMap.put(178, "AcceptDeliveryCommand");
		this.number2NameMap.put(148, "Account");
		this.number2NameMap.put(184, "AccountManager");
		this.number2NameMap.put(-186, "AccountService");
		this.number2NameMap.put(164, "AddArticleCommand");
		this.number2NameMap.put(155, "ArrivedOrder");
		this.number2NameMap.put(193, "Article");
		this.number2NameMap.put(188, "ArticleWrapper");
		this.number2NameMap.put(276, "BasicProductGroup");
		this.number2NameMap.put(210, "CancelCommand");
		this.number2NameMap.put(203, "Cart");
		this.number2NameMap.put(216, "CartManager");
		this.number2NameMap.put(202, "CartManagerArticleList");
		this.number2NameMap.put(153, "CartManagerOnDelivery");
		this.number2NameMap.put(169, "CartManagerStandardDelivery");
		this.number2NameMap.put(-211, "CartService");
		this.number2NameMap.put(214, "ChangeAmountCommand");
		this.number2NameMap.put(182, "ChangeChargeCommand");
		this.number2NameMap.put(176, "ChangeDescriptionCommand");
		this.number2NameMap.put(156, "ChangeMaxStockCommand");
		this.number2NameMap.put(207, "ChangeMinStockCommand");
		this.number2NameMap.put(205, "ChangePriceCommand");
		this.number2NameMap.put(171, "ChangeProductGroupCommand");
		this.number2NameMap.put(190, "ChangeRetourePercentageCommand");
		this.number2NameMap.put(183, "ChangeTimeCommand");
		this.number2NameMap.put(213, "CheckOutCommand");
		this.number2NameMap.put(215, "CheckedOut");
		...
		this.number2NameMap.put(162, "CustomerManager");
		this.number2NameMap.put(151, "CustomerOrder");
		this.number2NameMap.put(158, "CustomerOrderArticleList");
		this.number2NameMap.put(157, "CustomerPresets");
		this.number2NameMap.put(-140, "CustomerService");
		this.number2NameMap.put(170, "DepositCommand");
		this.number2NameMap.put(-103, "ErrorDisplay");
		this.number2NameMap.put(199, "FindArticleCommand");
		this.number2NameMap.put(165, "Manufacturer");
		this.number2NameMap.put(166, "NewlyAdded");
		this.number2NameMap.put(194, "OfferedFSale");
		this.number2NameMap.put(161, "OpenCart");
		this.number2NameMap.put(191, "OrderCommand");
		this.number2NameMap.put(187, "OrderManager");
		this.number2NameMap.put(-185, "OrderService");
		this.number2NameMap.put(152, "OverNightDelivery");
		this.number2NameMap.put(195, "PreOrder");
		this.number2NameMap.put(173, "PreOrderArticleList");
		this.number2NameMap.put(167, "PreorderCommand");
		this.number2NameMap.put(189, "PresetBalanceCommand");
		this.number2NameMap.put(198, "PresetLowerLimitCommand");
		this.number2NameMap.put(149, "ProductGroup");
		this.number2NameMap.put(204, "QuantifiedArticles");
		this.number2NameMap.put(160, "QuantifiedArticlesArticle");
		this.number2NameMap.put(-142, "RegisterService");
		this.number2NameMap.put(150, "RemoveFCartCommand");
		this.number2NameMap.put(180, "RemovedFSale");
		this.number2NameMap.put(181, "Retoure");
		this.number2NameMap.put(197, "RetoureArticleCommand");
		this.number2NameMap.put(206, "RetoureDeliveryCommand");
		this.number2NameMap.put(172, "SendOrder");
		...
		this.number2NameMap.put(-143, "ShopkeeperService");
		this.number2NameMap.put(154, "StandardDelivery");
		this.number2NameMap.put(174, "StartSellingCommand");
		this.number2NameMap.put(209, "Subj");
		this.number2NameMap.put(179, "TestDelivery");
		this.number2NameMap.put(201, "WithdrawCommand");	
	}
