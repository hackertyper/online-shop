...
public class CustomerOrderArticleListProxi extends PersistentProxi implements PersistentCustomerOrderArticleList{
    
    public CustomerOrderArticleListProxi(long objectId) {
        super(objectId);
    }
    public CustomerOrderArticleListProxi(PersistentInCacheProxi object) {
        super(object);
    }
