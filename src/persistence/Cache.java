...
/* ********************* Cache report ********************** */	
	...
	private void initializeNumber2NameMap() {
		...
		this.number2NameMap.put(-188, "AccountService");
		this.number2NameMap.put(146, "AddToCartCommand");
		this.number2NameMap.put(172, "ArrivedOrder");
		this.number2NameMap.put(144, "Article");
		this.number2NameMap.put(141, "Cart");
		this.number2NameMap.put(-187, "CartService");
		this.number2NameMap.put(160, "ChangeDescriptionCommand");
		this.number2NameMap.put(155, "ChangeManuDeliveryCommand");
		this.number2NameMap.put(158, "ChangePriceCommand");
		this.number2NameMap.put(157, "ChangeProductGroupCommand");
		this.number2NameMap.put(147, "CheckOutCommand");
		this.number2NameMap.put(-102, "CommandCoordinator");
		this.number2NameMap.put(-109, "CommandExecuter");
		this.number2NameMap.put(108, "CommonDate");
		this.number2NameMap.put(131, "Customer");
		this.number2NameMap.put(171, "CustomerOrder");
		this.number2NameMap.put(-103, "CustomerService");
		this.number2NameMap.put(133, "DepositCommand");
		this.number2NameMap.put(-106, "ErrorDisplay");
		this.number2NameMap.put(137, "FindArticleCommand");
		this.number2NameMap.put(153, "Manufacturer");
		this.number2NameMap.put(154, "NewlyAdded");
		this.number2NameMap.put(152, "OfferedFSale");
		this.number2NameMap.put(143, "OrderCommand");
		this.number2NameMap.put(140, "PayCommand");
		this.number2NameMap.put(150, "ProductGroup");
		this.number2NameMap.put(156, "QuantifiedArticles");
		this.number2NameMap.put(-101, "RegisterService");
		this.number2NameMap.put(161, "RemovedFSale");
		this.number2NameMap.put(175, "Retoure");
		this.number2NameMap.put(173, "SendOrder");
		this.number2NameMap.put(-104, "Server");
		this.number2NameMap.put(174, "ShopKeeperOrder");
		this.number2NameMap.put(-186, "ShopService");
		this.number2NameMap.put(151, "Shopkeeper");
		this.number2NameMap.put(-105, "ShopkeeperService");
		this.number2NameMap.put(159, "StartSellingCommand");
		this.number2NameMap.put(132, "WithdrawCommand");	
	}
