...
public class TestDelivery extends view.objects.CustomerDelivery implements TestDeliveryView{
    
    
    public TestDelivery(long time,long extraCharge,long id, long classId) {
