...
public class PreOrderArticleListICProxi extends PersistentInCacheProxiOptimistic implements PersistentPreOrderArticleList{
    
    public PreOrderArticleListICProxi(long objectId) {
        super(objectId);
    }
    public PreOrderArticleListICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().thePreOrderArticleListFacade
            .getPreOrderArticleList(this.getId());
    }
