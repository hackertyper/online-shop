...
public class OrderServiceProxi extends CustomerServiceProxi implements PersistentOrderService{
    
    public OrderServiceProxi(long objectId) {
        super(objectId);
    }
    public OrderServiceProxi(PersistentInCacheProxi object) {
        super(object);
    }
