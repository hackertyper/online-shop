...
public class PresetBalanceCommandProxi extends PersistentProxi implements PersistentPresetBalanceCommand{
    
    public PresetBalanceCommandProxi(long objectId) {
        super(objectId);
    }
    public PresetBalanceCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
