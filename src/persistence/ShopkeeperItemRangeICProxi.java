...
public class ShopkeeperItemRangeICProxi extends PersistentInCacheProxiOptimistic implements PersistentShopkeeperItemRange{
    
    public ShopkeeperItemRangeICProxi(long objectId) {
        super(objectId);
    }
    public ShopkeeperItemRangeICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theShopkeeperItemRangeFacade
            .getShopkeeperItemRange(this.getId());
    }
